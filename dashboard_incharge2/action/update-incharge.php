...
$update_query = "UPDATE registered_incharge SET IDnumber='$idnumber', firstname='$fname', middlename='$mname', lastname='$lname', email='$email', department='$depart' WHERE department='ENGINEERING'";
