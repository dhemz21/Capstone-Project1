...
foreach ($data as $row) {
    ...
    $sql = "INSERT INTO online_attendance2 (Registered_ID, Event_ID, firstname, middlename, lastname, email, time_in, login_type, eventType) VALUES ('$reg_id', $event_id, '$fname', '$mname', '$lname', '$mail',  '$time', '$type', '$event')";
