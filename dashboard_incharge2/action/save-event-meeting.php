...
if (isset($_POST['text'])) {
    ...
    if ($count == 1) {
        ...
        if($count > 0){
            ...
            echo "<script>window.location.href='.?folder=pages/&page=event-scan&userID=$event_id';</script>"; 
        } else {
            $scanned_data = array(
            ...
            if (check_internet_connection()) {
                ...
                $sql = "INSERT INTO online_attendance2 (Registered_ID, Event_ID, firstname, middlename, lastname, email, time_in, login_type, eventType) VALUES ('$reg_id', '$event_id', '$fname', '$mname', '$lname', '$mail', '$time','$type', 'MEETING')";
