    ...
    <div class="col-12">
      <div class="card shadow-sm">
        <div class="card-header bg-light">
          <h3 class="card-title"><strong>scan qrcode for seminar</strong></h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table class="table table-responsive table-bordered">
            ...
            <tbody>
              <?php
              $i = 0;
              $sql = mysqli_query($conn, "SELECT * FROM incharge_add_event WHERE eventType='SEMINAR' AND fromwho='ENGINEERING'");
