...
<body>
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="col-12 mt-2 mb-2">
            <p class="text-start"><a href=".?page=event-activity" class="text-decoration-none">Go Back</a> </p>
          </div>
          <!-- /.card-body -->
        </div>
        <!-- /.card -->
  ...
  <script src="js/delete_record3.js"></script>
...
document.getElementById('generate').addEventListener('click', function() {
    ...
    addMeeting(doc);
    addTable(doc, table);
    doc.save('Activity_Attendance.pdf');
  };
});
...
function addTable(doc, table) {
  ...
  doc.text(label, x + textWidth + 115, y);
  doc.setFontSize(10); // Set font size for the URL
  doc.setTextColor(0, 0, 255); // Set text color to blue
  doc.textWithLink(linkUrl, x + textWidth + 115 + labelWidth, y, { url: linkUrl });
}
  });
}
  </script>
