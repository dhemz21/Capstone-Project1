        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center shadow" id="main-container" style="min-height: 450px;">
            <div class="container-title w-100">
              ...
              <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=employee_reset" novalidate>
                <div class="col-12">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input name="IDnumber" type="text"class="input form-control rounded-0" id="IDnumber" placeholder="Enter your employee ID" aria-label="IDnumber" aria-describedby="basic-addon1" required />
                  </div>
                </div>
                <div class="col-12">
