              ...
              <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=guest_regEmail" novalidate>
                <div class="col-12">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input name="email" type="text"class="input form-control rounded-0" id="email" placeholder="Enter your email address" aria-label="email" aria-describedby="basic-addon1" required />
                  </div>
                </div>
                <div class="col-12">
                  <button class="btn btn text-white w-100" id="btn" type="submit" name="submit">Verify email</button>
                </div>
                <div class="col-12 mt-5">
                <p class="text-start"><a href=".?page=guest_register" class="text-decoration-none">Go Back</a> </p>
                </div>
              </form>
            </div>
          </div>
