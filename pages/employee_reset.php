        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center shadow" id="main-container" style="min-height: 450px;">
            <div class="container-title w-100">
              ...
              <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=employee_update" novalidate>
              <?php
            ...
            ?>
              <div class="col-12">
                ...
                <div class="col-12">
                  <button class="btn text-white w-100" id="btn" type="submit" disabled>Submit</button>
                </div>
