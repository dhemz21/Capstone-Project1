              ...
              <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=guest_check" novalidate>
                <div class="col-12">
                  <div class="input-group mb-3">
                    ...
                    <input name="username" type="text" value="" class="input form-control rounded-0" id="username" placeholder="Username"required />
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="input-group mb-3">
                    ...
                    <input name="password" type="password" value="" class="input form-control rounded-0" id="password" placeholder="Password" required="true"required />
