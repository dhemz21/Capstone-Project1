    ...
    <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
      ...
      <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center shadow" id="main-container" style="min-height: 450px;">
        ...
        <div class="employee-form">
          ...
          <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=employee_verify_otp" novalidate>
          <input type="hidden" name="IDnumber" class="input form-control rounded-0">
            <div class="col-12">
              ...
              <div class="input-group mb-3">
                ...
                <input name="otp" type="text" class="input form-control rounded-0" id="otp" placeholder="Enter your OTP" required />
              </div>
            </div>
            <div class="col-12">
              <button class="btn btn text-white w-100" id="btn" type="submit" name="submit">Verify</button>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-12 mb-2">
              <p class="text-start"><a href=".?page=employee_register" class="text-decoration-none">Go Back</a> </p>
            </div>
          </form>
        </div>
      </div>
