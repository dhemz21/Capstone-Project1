        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center shadow" id="main-container" style="min-height: 450px;">
            <div class="container-title w-100">
              ...
              <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=employee_insert" novalidate>
             <?php
            // Connect to the database
            require_once('database/db_conn.php');
            // Get the user information from the database using the ID number
            $idnumber = $_SESSION['IDnumber'];
            $query = "SELECT IDnumber, firstname, middlename, lastname, email, department FROM tbl_employee WHERE IDnumber='$idnumber'";
            ...
            <div class="col-md-6">
              <div class="input-group mb-2">
                ...
                <p class="text-center"><a href=".?page=employee_login" class="text-decoration-none">Login</a> </p>
                </div>
              </form>
            </div>
          </div>
