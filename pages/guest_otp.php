    ...
    <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
      ...
      <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center shadow" id="main-container" style="min-height: 450px;">
        ...
        <div class="guest-form">
          ...
          <form class="row g-3 needs-validation" method="post" action=".?folder=action/&page=guest_verify_otp" novalidate>
          <input type="hidden" name="email" class="input form-control rounded-0">
            <div class="col-12">
              ...
              <div class="input-group mb-3">
                ...
                <input name="otp" type="text" class="input form-control" id="otp" placeholder="Enter your OTP" required />
              </div>
            </div>
            <div class="col-12">
