    ...
    if ($count == 1) {
        ...
        if($count > 0){
            ...
            if (check_internet_connection()) {
                ...
                $sql = "INSERT INTO online_attendance (Registered_ID, Event_ID, firstname, middlename, lastname, email, time_in, login_type, eventType) VALUES ('$reg_id', '$event_id', '$fname', '$mname', '$lname', '$mail', '$time','$type', 'MEETING')";
