                    ...
                    <div class="inner">
                        ...
                        <?php
                         require_once("../../database/db_conn.php");
                          $query = 'SELECT COUNT(*) AS total FROM registered_users WHERE department="ENGINEERING"';
            ...
            <div class="col-lg-4 col-6">
                ...
                <div class="small-box text-white shadow-sm" id="box3">
                    <div class="inner">
                        ...
                        <?php
                        require_once("../../database/db_conn.php");
                        $query = "SELECT COUNT(*) FROM online_attendance2";
                        $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
            ...
            <div class="col-lg-4 col-6">
                ...
                <div class="small-box text-white shadow-sm" id="box2">
                    <div class="inner">
                        ...
                        <?php
                            require_once("../../database/db_conn.php");
                            $query = "SELECT COUNT(*) AS total FROM incharge_add_event WHERE fromwho='ENGINEERING'";
                            $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
