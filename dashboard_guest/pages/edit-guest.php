      ...
      <div class="card-body">
        ...
        ?>
          <form action=".?folder=action/&page=update-guest-info" method="POST" enctype="multipart/form-data">
            ...
            <div class="btn-add">
              <a href=".?page=guest-add-photo" class="btn text-white rounded-0 shadow-none" id="add">Add Photo</a>
            </div>
            <div class="form-row">
          ...
          <button type="reset" class="btn btn-secondary rounded-0 shadow-none" onclick="window.location.href='.?page=guest-info'">Close</button>

          </form>
      </div>
      <div class="col-12 mt-3 mb-2">
        <p class="text-start"><a href=".?page=guest-info" class="text-decoration-none">Go Back</a> </p>
      </div>
    </div>
  </div>
