...
<aside class="main-sidebar sidebar-dark-danger elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href=".?page=guest-info" class="d-block"><?php echo $_SESSION['Firstname'] ?> <?php echo $_SESSION['Lastname'] ?></a>
      </div>
    </div>
    <!-- Sidebar Menu -->
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <div class="row">
          <div class="col-12 mb-2 ">
            <div id="btn-menu">
              <a href=".?folder=pages/&page=guest-info" class="btn rounded-0 text-white w-100" id="edit-profile"><i class="nav-icon fas fa-edit"></i> Edit Profile</a>
            </div>
          </div>
        </div>
      ...
      <button type="button" class="btn btn-info mt-2 mb-1 w-100 rounded-0">
