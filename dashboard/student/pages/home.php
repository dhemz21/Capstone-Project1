...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="alert alert-primary alert-dismissible fade show rounded-0 shadow-none" role="alert">
            <p>
                Hi! <strong><?php echo $_SESSION['Firstname'] ?></strong> Welcome to your Dashboard, Student for <strong><?php echo $_SESSION['Department'] ?></strong> Department!
            </p>
            ...
            <div class="col-lg-4 col-6">
                <!-- small box -->
                <div class="small-box text-white rounded-0 shadow-sm" id="box1">
                    <div class="inner">
                        <h4>Qr Code</h4>
                        <h3>1</h3>
                        <p>Your Qr Code</p>
            ...
            <div class="col-lg-4 col-6">
                <!-- small box -->
                <div class="small-box text-white rounded-0 shadow-sm" id="box2">
                    <div class="inner">
                        <h4>School Events</h4>
                        <?php
