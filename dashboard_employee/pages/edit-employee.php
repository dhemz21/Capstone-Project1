  ...
  <div class="container-fluid pb-3">
    ...
    <div class="card rounded-0 shadow-sm">
      <div class="card-header rounded-0">
        <h3 class="card-title text-dark"><strong>Update Your Information</strong></h3>
      </div>
      <div class="card-body">
        <?php
        ...
        ?>
          <form action=".?folder=action/&page=update-employee-info" method="POST" enctype="multipart/form-data">
            ...
            <div class="btn-add">
              <a href=".?page=employee-add-photo" class="btn text-white rounded-0 shadow-none" id="add">Add Photo</a>
            </div>
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="email" class="form-control rounded-0 " name="email" value="<?php echo $getData['email']; ?>">
              </div>
              <div class="form-group col-md-6">
                <label for="fname">Firstname</label>
                <input type="text" class="form-control rounded-0 " name="Firstname" value="<?php echo $getData['Firstname']; ?>">
              </div>
              <div class="form-group col-md-6">
          ...
          <button type="submit" id="save" class="btn rounded-0 text-white shadow-none">Save</button>
          <button type="reset" class="btn btn-secondary rounded-0 shadow-none" onclick="window.location.href='.?page=employee-info'">Close</button>

          </form>
      </div>
      <div class="col-12 mt-3 mb-2">
        <p class="text-start"><a href=".?page=employee-info" class="text-decoration-none">Go Back</a> </p>
      </div>
    </div>
  </div>
